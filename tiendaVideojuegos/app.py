...
def get_game(game_id):
    ...
    return jsonify({"id": game.id, "title": game.title, "description": game.description, "price": game.price, "stock": game.stock})
...
def get_user_orders(user_id):
    ...
    return jsonify([{"id": o.id, "total_price": o.total_price, "created_at": o.created_at} for o in orders])
...
def get_order(order_id):
    ...
    return jsonify({
        ...
        "items": [{"game_id": i.game_id, "quantity": i.quantity, "price": i.price} for i in order.items]
    })
